...
/*
 ...
 EXHIBIT 2: IMPLEMENTING CUSTOM BINDING / CUSTOM ENGINE
     ...
     while (true)
     {
        ...
        ImGui::Text("Hello, physicsWorld!");
        MyGameUpdate(); // may use any ImGui functions, e.g. ImGui::Begin("My window"); ImGui::Text("Hello, physicsWorld!"); ImGui::End();
 ...
 A: When loading a font, pass custom Unicode ranges to specify the glyphs to load.
      ...
      builder.AddText("Hello physicsWorld");                        // Add a string (here "Hello physicsWorld" contains 7 unique characters)
