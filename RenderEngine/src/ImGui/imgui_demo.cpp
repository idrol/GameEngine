...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Capture/Logging"))
        {
            ...
            if (ImGui::Button("Copy \"Hello, physicsWorld!\" to clipboard"))
            {
                ImGui::LogToClipboard();
                ImGui::LogText("Hello, physicsWorld!");
                ImGui::LogFinish();
            }
            ImGui::TreePop();
        }
    ...
    if (ImGui::CollapsingHeader("Widgets"))
    {
        if (ImGui::TreeNode("Basic"))
        {
            ...
            {
                static char str0[128] = "Hello, physicsWorld!";
                static int i0 = 123;
    ...
    if (ImGui::CollapsingHeader("Columns"))
    {
        ...
        if (ImGui::TreeNode("Basic"))
        {
            ...
            ImGui::Text("Pathfinding"); ImGui::NextColumn();
    ...
    if (ImGui::CollapsingHeader("Filtering"))
    {
        ...
        filter.Draw();
        const char* lines[] = { "aaa1.c", "bbb1.c", "ccc1.c", "aaa2.cpp", "bbb2.cpp", "ccc2.cpp", "abc.h", "hello, physicsWorld" };
...
//  my_log.AddLog("Hello %d physicsWorld\n", 123);
//  my_log.Draw("title");
