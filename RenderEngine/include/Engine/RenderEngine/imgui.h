...
#ifndef IMGUI_API
#define IMGUI_API RENDERENGINE_API
#endif
...
struct ImGuiIO
{
    ...
    const char*   IniFilename;              // = "imgui.ini"        // Pathfinding to .ini file. Set NULL to disable automatic .ini loading/saving, if e.g. you want to manually load/save from memory.
    const char*   LogFilename;              // = "imgui_log.txt"    // Pathfinding to .log file (default parameter to ImGui::LogToFile when no file is specified).
...
struct ImFontAtlas
{
    ...
    // NB: Make sure that your string are UTF-8 and NOT in your local code page. In C++11, you can create UTF-8 string literal using the u8"Hello physicsWorld" syntax. See FAQ for details.
